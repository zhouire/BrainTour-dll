...
struct Scene
{
	...
	*/
	...
	//void moveTempModels(Posef rightPose, Quatf& gPose, Vector3f &gHeadPos, Matrix4f &gHeadOrientation, Matrix4f& view)
	void moveTempModels(Vector3f rightPosePos, glm::quat& rightQ, Vector3f &gHeadPos, Matrix4f &gHeadOrientation, Matrix4f& view)
	{
		//glm::quat rightQ = _glmFromOvrQuat(rightPose.Orientation);

		Vector3f pos = rightPosePos;
